...
edge1: addi    $a0, $zero, 90	# Marsbot rotates 90*
	jal     ROTATE
...
edge2: addi  	$a0, $zero, 180	# Marsbotrotates 180*  
	jal   	ROTATE
...
edge3:  addi  	$a0, $zero, 270 # Marsbot rotates 270*  
	jal   	ROTATE    
...
sleep4: addi    $v0,$zero,32    # Keep running by sleeping in 2000 ms
 ...
 edge4:  addi  	$a0, $zero, 0 	# Marsbot rotates 0*  
	jal   	ROTATE    
