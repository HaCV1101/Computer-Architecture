...
edge1: addi    $a0, $zero, 162	# Marsbot rotates 162*
	jal     ROTATE
...
edge2: addi  	$a0, $zero, 306	# Marsbotrotates 306*  
	jal   	ROTATE
...
edge3:  addi  	$a0, $zero, 90 # Marsbot rotates 90*  
	jal   	ROTATE    
...
edge4:  addi  	$a0, $zero, 234 # Marsbot rotates 234*  
	jal   	ROTATE    
...
sleep5: addi    $v0,$zero,32    # Keep running by sleeping in 2000 ms
	li      $a0,8000       
 	...
 	jal     UNTRACK         # Keep old track
 	jal 	TRACK		# And draw new track line
edge5:  addi  	$a0, $zero, 18 	# Marsbot rotates 18*  
	jal   	ROTATE    
