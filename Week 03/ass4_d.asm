#Laboratory Exercise 3, Assignment 4, i+j>m+n
.data
...
.text
	addi $k0,$zero,10 	#khoi tao gia tri cho m
	addi $k1,$zero,12 	#khoi tao gia tri cho n
	...
	add $s6,$s1,$s2 # tinh tong i+jj
	add $s7,$k0,$k1 # tinh tong m+n
start:
	slt	$t0,$s7,$s6		#m+n<i+j thì $t0=1
	beq	$t0,$zero,else		#$t0=0 thi else
